...
- 2c8c5bc: Remove email/password login and make ARL the only login method.
...
- 508a716: Prevent application crash if some content is not available (geo-restricted, else)
