!(function (r, e) {
	...
	var d = { ECB: 0, CBC: 1 },
		v = { PKCS5: 0, ONE_AND_ZEROS: 1, LAST_BYTE: 2, NULL: 3, SPACES: 4 },
		o = { STRING: 0, UINT8_ARRAY: 1 },
		p = [
			608135816,
			2242054355,
			320440878,
	...
	return (function () {
		...
		return (
			...
			(n._f = function (r) {
				var e = h(this.s[0][(r >>> 24) & 255], this.s[1][(r >>> 16) & 255]);
				return h((e = B(e, this.s[2][(r >>> 8) & 255])), this.s[3][255 & r]);
			}),
			...
			(n._encodeCBC = function (r) {
				for (
					var e = new Uint8Array(r.length),
						t = E(this.iv[0], this.iv[1], this.iv[2], this.iv[3]),
						n = E(this.iv[4], this.iv[5], this.iv[6], this.iv[7]),
						i = 0;
					i < r.length;
					i += 8
				) {
