  ...
  <div class="fixed-footer">
    ...
    >
      ...
      <div v-else>
        <div class="flex w-full">
          ...
          <div
            class="grid card bg-base-300 rounded-box place-items-center"
            style="width:100%"
          >
    ...
    <BaseAccordion class="settings-group">
      ...
      <div class="languages">
        <a
          ...
          :key="locale"
          class="languages__item flex items-center px-3 py-3 no-underline capitalize"
          :class="{
          ...
          href="#"
          tabindex="0"
          @click="currentLocale !== locale && changeLocale(locale)"
        >
          <span
            class="w-6 h-6 flex"
    ...
    <BaseAccordion class="settings-group">
      ...
      <BaseAccordion class="settings-group">
        ...
        <div class="space-x-5 settings-container">
          <div class="settings-container__third">
            ...
            <div
              v-if="settings.createPlaylistFolder"
              class="input-group"
            >
              ...
              <input
                v-model="settings.playlistNameTemplate"
                type="text"
              >
            </div>
          </div>
          <div class="settings-container__third">
            ...
            <div
              v-if="settings.createArtistFolder"
              class="input-group"
            >
              <p class="input-group-text">
              ...
              <input
                v-model="settings.artistNameTemplate"
                type="text"
              >
            </div>
          </div>
          <div class="settings-container__third">
            <label class="with-checkbox">
              <input
                v-model="settings.createAlbumFolder"
                type="checkbox"
              >
            ...
            <div
              v-if="settings.createAlbumFolder"
              class="input-group"
            >
              <p class="input-group-text">
              ...
              <input
                v-model="settings.albumNameTemplate"
                type="text"
              >
            </div>
          </div>
        ...
        <label class="with-checkbox">
          <input
            v-model="settings.createCDFolder"
            type="checkbox"
          >
        ...
        <label class="with-checkbox">
          <input
            v-model="settings.createSingleFolder"
            type="checkbox"
          >
      ...
      <BaseAccordion class="settings-group">
        ...
        <input
          v-model="settings.tracknameTemplate"
          type="text"
        >
        ...
        <input
          v-model="settings.albumTracknameTemplate"
          type="text"
        >
        <TemplateVariablesList
          :template-variables="trackTemplateVariables"
        ...
        <input
          v-model="settings.playlistTracknameTemplate"
          type="text"
        >
        <TemplateVariablesList
          :template-variables="trackTemplateVariables"
      ...
      <BaseAccordion class="settings-group">
        ...
        >
          ...
          <input
            v-model="settings.coverImageTemplate"
            type="text"
          >
        </div>
        ...
        <label class="with-checkbox">
          <input
            v-model="settings.saveArtworkArtist"
            type="checkbox"
          >
        ...
        <div
          v-if="settings.saveArtworkArtist"
          class="input-group"
        >
          <p class="input-group-text">
          ...
          <input
            v-model="settings.artistImageTemplate"
            type="text"
          >
        </div>
        ...
        <label class="with-checkbox">
          <input
            v-model="settings.embeddedArtworkPNG"
            type="checkbox"
          >
      ...
      <BaseAccordion class="settings-group">
        <template #title>
          <h3 class="settings-group__header">
            ...
            >bookmarks</i>{{ $t('settings.tags.head') }}
          </h3>
        </template>
        ...
        <div class="space-x-5 settings-container">
          <div class="settings-container__half">
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.trackNumber"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.trackTotal"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.discNumber"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.discTotal"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.albumArtist"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.explicit"
                type="checkbox"
              >
          ...
          <div class="settings-container__half">
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.replayGain"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.syncedLyrics"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.copyright"
                type="checkbox"
              >
            ...
            <label class="with-checkbox">
              <input
                v-model="settings.tags.composer"
                type="checkbox"
              >
        ...
        <p
          v-if="settings.tags.multiArtistSeparator != 'default' && !settings.tags.artists"
          style="opacity: 0.75; color: #ffcc22"
        >
      ...
      <div class="input-group">
        ...
        <select v-model="settings.maxBitrate">
          <option
            value="9"
            :disabled="!canDownload(9)"
          >
            {{ $t('settings.downloads.maxBitrate.9') }}
          </option>
          <option
            value="3"
            :disabled="!canDownload(3)"
          >
            {{ $t('settings.downloads.maxBitrate.3') }}
          </option>
          <option
            value="1"
            :disabled="!canDownload(1)"
          >
      ...
      <div class="space-x-5 settings-container">
        <div class="settings-container__third settings-container__third--only-checkbox">
          <label class="with-checkbox">
            <input
              v-model="settings.fallbackBitrate"
              type="checkbox"
            >
          ...
          <label class="with-checkbox">
            <input
              v-model="settings.fallbackSearch"
              type="checkbox"
            >
        ...
        <div class="settings-container__third settings-container__third--only-checkbox">
          ...
          <label class="with-checkbox">
            <input
              v-model="settings.createM3U8File"
              type="checkbox"
            >
      ...
      >
        ...
        <input
          v-model="settings.playlistFilenameTemplate"
          type="text"
        >
      </div>
      ...
      >
        <input
          v-model="settings.clearQueueOnExit"
          type="checkbox"
        >
      ...
      <label class="with-checkbox">
        <input
          v-model="settings.tags.useNullSeparator"
          type="checkbox"
        >
      ...
      <label class="with-checkbox">
        <input
          v-model="settings.tags.saveID3v1"
          type="checkbox"
        >
      ...
      <div class="input-group">
        ...
        <select v-model="settings.tags.multiArtistSeparator">
          ...
          <option value=" & ">
            {{ $t('settings.other.multiArtistSeparator.using', { separator: ' & ' }) }}
          </option>
          <option value=",">
            {{ $t('settings.other.multiArtistSeparator.using', { separator: ',' }) }}
          </option>
      ...
      <label class="with-checkbox">
        <input
          v-model="settings.albumVariousArtists"
          type="checkbox"
        >
      ...
      <label class="with-checkbox">
        <input
          v-model="settings.removeAlbumVersion"
          type="checkbox"
        >
      ...
      <div class="input-group">
        ...
        <p v-if="settings.executeCommand">
          {{ settings.executeCommand }}
        </p>
        <p v-else>
          {{ $t('globals.empty').capitalize() }}
        </p>
      </div>
    </BaseAccordion>
    ...
    <BaseAccordion class="settings-group">
      ...
      <BaseAccordion class="settings-group">
        ...
        <div class="input-group">
          ...
          <input
            v-model="spotifyFeatures.clientId"
            type="text"
          >
        </div>
        <br>
        <div class="input-group">
          ...
          <input
            v-model="spotifyFeatures.clientSecret"
            type="password"
          >
        </div>
        <br>
        <div class="input-group">
          ...
          <p style="font-size: 13px; font-style: italic;">
            ...
            'https://open.spotify.com/user/' and can be a set of alphanumeric characters or a profile name.<br>You can also insert your own Spotify user ID as before.
          </p>
          <input
            v-model="spotifyUser"
            type="text"
        ...
        <label class="with-checkbox">
          <input
            v-model="spotifyFeatures.fallbackSearch"
            type="checkbox"
          >
          <span class="checkbox-text">{{ $t('settings.downloads.fallbackSearch') }}</span>
        </label>
