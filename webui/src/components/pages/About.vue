  ...
  <div id="about_tab">
    ...
    >
      ...
      - Created <a
        target="_blank"
        href="https://t.me/DeemixFix"
      > Releases Channel </a>Subscribe for
    ...
    <ul class="no-dots">
      <li>
        <a
          href="https://gitlab.com/deeplydrumming/DeemixFix"
          target="_blank"
    ...
    <ul>
      <i18n
        path="about.questions.text"
        tag="li"
      >
        <template #telegram>
          <a
            href="https://t.me/deemixcommunity"
            target="_blank"
          >{{ $t('about.questions.telegram') }}</a>
        </template>
      </i18n>
      <!-- <li>
    ...
    <ul>
      ...
      <i18n
        path="about.contributeWebUI.text"
        tag="li"
      >
        <template #webui>
    ...
    <i18n
      path="about.lincensedUnder.text"
      tag="p"
    >
      <template #gpl3>
        <a
