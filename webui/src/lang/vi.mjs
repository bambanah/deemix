const vi = {
	...
	about: {
		...
		subtitles: {
			bugReports:
				"Bạn thấy có gì đó không hoạt động trong deemix? Xin hãy báo với chúng tôi!",
			contributing:
				"Bạn muốn đóng góp cho dự án này? Bạn có thể làm điều đó với nhiều cách khác nhau!",
		...
		thanks:
			"Cảm ơn <strong>rtonno</strong>, <strong>uhwot</strong> và <strong>lollilol</strong> đã giúp tôi với dự án này và <strong>BasCurtiz</strong> với việc thiết kế biểu tượng.",
		upToDate: {
		...
		beforeReporting:
			"Trước khi báo lỗi hãy đảm bảo bạn đang sử dụng phiên bản mới nhất của ứng dụng và lỗi bạn đang gặp không phải là do bạn.",
		beSure:
			"Hãy đảm bảo là lỗi này vẫn có thể xảy ra trên các thiết bị khác và <strong>XIN ĐỪNG</strong> báo lỗi đã được báo rồi.",
		duplicateReports:
			"Những bản báo lỗi trùng nhau sẽ bị đóng, xin bạn hãy để ý điều này.",
		dontOpenIssues:
			"<strong>XIN ĐỪNG</strong> mở vấn đề để hỏi, bạn có thể dùng subreddit trên cho việc đó.",
		newUI: {
		...
		acceptFeatures:
			"Tôi có chấp nhận yêu cầu về tính năng mới nhưng không quá phức tạp bởi vì chúng có thể được triển khai trực tiếp vào ứng dụng thay vì vào thư viện.",
		otherLanguages:
			"Nếu bạn thành thạo với một ngôn ngữ khác, bạn có thể port deemix sang ngôn ngữ đó!",
		understandingCode:
			"Bạn muốn hiểu code của deemix? Xin hãy liên lạc waLplanet trên Telegram hoặc Reddit.",
		contributeWebUI: {
			text: "Nếu bạn biết Vue.js (JavaScript), HTML hoặc CSS, bạn có thể góp phần phát triển {webui}.",
			webui: "WebUI",
		},
		itsFree:
			"Bạn nên nhớ rằng <strong>đây là một dự án phi lợi nhuận</strong> và <strong>bạn nên ủng hộ những Nghệ sĩ yêu thích của bạn</strong> trước khi ủng hộ nhà phát triển.",
		notObligated:
			"Đừng nghĩ rằng bạn phải đóng góp tiền, tôi vẫn sẽ rất biết ơn bạn!",
		lincensedUnder: {
	...
	errors: {
		...
		ids: {
			...
			notYourPrivatePlaylist:
				"Bạn không thể tải xuống playlist riêng của người khác.",
			...
			notEncodedNoAlternative:
				"Bài hát chưa được encode và không có bản thay thế nào khác!",
			wrongBitrate: "Bài hát này không có ở bitrate bạn muốn.",
			wrongBitrateNoAlternative:
				"Bài hát này không có ở bitrate bạn muốn và không có bản thay thế nào khác!",
			...
			notAvailableNoAlternative:
				"Bài hát này không có trên server của Deezer và không có bản thay thế nào khác!",
		},
	},
	favorites: {
		title: "Yêu thích",
	...
	home: {
		needTologin:
			"Bạn cần phải đăng nhập vào tài khoản Deezer trước khi bắt đầu tải xuống.",
	...
	linkAnalyzer: {
		...
		linkNotSupportedYet:
			"Đường link này chưa được hỗ trợ, xin hãy thử lại với một đường link khác.",
		table: {
			id: "ID",
			isrc: "ISRC",
			upc: "UPC",
	...
	toasts: {
		...
		startConvertingSpotifyPlaylist:
			"Đang chuyển đổi các bài hát từ Spotify sang Deezer",
