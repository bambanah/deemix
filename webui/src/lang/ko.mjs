const ko = {
  globals: {
    welcome: 'DeemixFix에 오신 것을 환영합니다',
    back: '뒤로',
    loading: '불러오는 중',
    download: '{thing} 다운로드',
    by: '- {artist}',
  ...
  about: {
   ...
   '이 프로그램은 <strong>deemix</strong> 라이브러리를 사용합니다, 해당 라이브러리로 자신만의 deemix를 만들 수 있습니다.',
    ...
    questions: {
      text: '프로그램에 대한 질문이나 문제에 관한 것은, 먼저 {telegram}에서 답변을 검색해보세요. 그리고, 서브레딧에서 답변을 찾기 못한 경우에 다음 순서를 이용해주세요.',
      telegram: '서브레딧'
    },
    ...
    understandingCode: '코드를 이해하는 데 도움이 필요합니까? 위에 있는 waLplanet, 텔레그램, 서브레딧 링크를 누르세요.',
    contributeWebUI: {
