const pl = {
  ...
  about: {
    ...
    subtitles: {
      ...
      contributing:
        "Chcesz pomóc w tym projekcie? Możesz to zrobić na wiele sposobów!",
    ...
    thanks:
      "Podziękowania dla <strong>rtonno</strong>, <strong>uhwot</strong> i <strong>lollilol</strong> za pomoc w tym projekcie oraz dla <strong>BasCurtiz</strong> za stworzenie ikony.",
    upToDate: {
    ...
    beforeReporting:
      "Przed zgłaszaniem błędu upewnij się, że masz najnowszą wersje aplikacji i to, co chcesz zgłosić jest błędem, a nie usterką z twojej strony.",
    beSure:
      "Upewnij się, że błąd można odtworzyć na innych urządzeniach i <strong>NIE ZGŁASZAJ</strong> błędów, które zostały już zgłoszone",
    duplicateReports:
      "Identyczne zgłoszenia błędów będą zamykane, więc zwróć na to uwagę.",
    dontOpenIssues:
      "<strong>NIE OTWIERAJ</strong> zgłoszeń do zadawania pytań, od tego jest subreddit.",
    newUI: {
    ...
    acceptFeatures:
      "Przyjmuję nowe funkcje, ale nic złożonego, co mogłoby być zaimplementowane w aplikacji, a nie w bibliotece.",
    otherLanguages:
      "Jeżeli dobrze znasz inny język programowania, możesz spróbować przeportować deemix do innych języków!",
    understandingCode:
      "Potrzebujesz pomocy w zrozumieniu kodu? Zapytaj waLplanet na Telegramie lub Reddicie.",
    contributeWebUI: {
      text: "Jeżeli znasz Vue.js (JavaScript), HTML lub CSS, możesz pomóc w {webui}.",
      webui: "WebUI",
    },
    itsFree:
      "Pamiętaj, że <strong>ten projekt jest darmowy</strong> i <strong>powinieneś wspierać artystów</strong> przed twórcami aplikacji.",
  ...
  errors: {
    ...
    ids: {
      ...
      notYourPrivatePlaylist:
        "Nie możesz pobierać czyichś prywatnych playlist.",
      ...
      notEncodedNoAlternative:
        "Utwór nie jest jeszcze zakodowany i nie można znaleźć alternatywy!",
      wrongBitrate: "Nie znaleziono utworu w wybranym bitrate.",
      wrongBitrateNoAlternative:
        "Nie znaleziono utworu w wybranym bitrate i nie mozna znaleźć alternatywy!",
      ...
      notAvailableNoAlternative:
        "Utwór nie jest dostępny na serwerach Deezera i nie można znaleźć alternatywy!",
    },
  },
  favorites: {
    title: "Ulubione",
  ...
  home: {
    needTologin:
      "Musisz się zalogwać do konta na Deezerze zanim zaczniesz pobierać.",
  ...
  linkAnalyzer: {
    ...
    linkNotSupportedYet:
      "Wygląda na to, że ten link nie jest jeszcze wspierany. Spróbuj przeanalizować inny.",
    table: {
      id: "ID",
      isrc: "ISRC",
      upc: "UPC",
  ...
  search: {
    ...
    description:
      "Możesz wyszukać utwór, album, artystę, playlistę... wszystko! Możesz też wkleić link do Deezera",
    fans: "{n} fanów",
  ...
  settings: {
    ...
    covers: {
      ...
      embeddedPNGWarning:
        "PNG nie jest oficjalnie wspierane przez Deezer i może powodować błędy",
      imageSizeWarning:
        "Wszystko powyżej x1200 nie jest oficjalnie używane przez Deezera, więc mogą wystąpić problemy.",
    },
    tags: {
