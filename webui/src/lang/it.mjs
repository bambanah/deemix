const it = {
  ...
  about: {
    ...
    updates: {
      ...
      updateAvailable:
        "Non stai usando l'ultima versione disponibile: {version}",
    ...
    thanks:
      "Un ringraziamento a <strong>rtonno</strong>, <strong>uhwot</strong> e <strong>lollilol</strong> per l'aiuto che mi stanno dando in questo progetto e a <strong>BasCurtiz</strong> per aver creato l'icona.",
    upToDate: {
    ...
    beforeReporting:
      "Prima di segnalare un problema controlla che quella che stai usando sia l'ultima versione dell'app e che ciò che vuoi segnalare sia effettivamente un problema e non qualcosa che non funziona solamente a te.",
    beSure:
      "Assicurati che il problema sia riproducibile su altri PC e <strong>NON</strong> segnalare un problema che è già stato segnalato.",
    duplicateReports:
      "Le segnalazioni doppie verranno chiuse, tienilo presente.",
    dontOpenIssues:
      "<strong>NON</strong> aprire issues per porre domande, per quello esiste un subreddit.",
    newUI: {
    ...
    acceptFeatures:
      "Accetto anche funzionalità, ma non cose complesse, dato che possono essere implementate direttamente nell'app invece che nella libreria.",
    otherLanguages:
      "Se te la cavi in altri linguaggi di programmazione, puoi provare a scrivere deemix in quei linguaggi!",
    understandingCode:
      "Serve aiuto per capire il codice? Scrivi a waLplanet su Telegram o Reddit",
    contributeWebUI: {
      text: "Se te la cavi con Vue.js (JavaScript), HTML o CSS, puoi contribuire alla {webui}.",
      webui: "WebUI",
    },
    itsFree:
      "Ricordati che <strong>questo è un progetto gratuito</strong> e che <strong>dovresti supportare gli artisti che ami</strong> prima di supportare gli sviluppatori.",
    notObligated:
      "Non sentirti obbligato a donare, mi stai simpatico lo stesso!",
    lincensedUnder: {
  ...
  toasts: {
    ...
    queueErrorCantStream:
      "Il tuo account non può ascoltare brani in {bitrate}!",
    deezerNotAvailable:
