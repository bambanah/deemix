const fil = {
  ...
  about: {
    ...
    subtitles: {
      ...
      contributing:
        "Gusto mo bang tumulong sa proyektong ito? Pwede mong gawin iyan sa maraming paraan!",
      donations:
        "Gusto mo bang tumulong sa pamamagitan ng pera? Pwede kang magbigay ng donasiyon!",
    },
    usesLibrary:
    ...
    thanks:
      "Salamat kay <strong>rtonno</strong>, <strong>uhwot</strong> at <strong>lollilol</strong> sa pagtulong sa akin para sa proyektong ito at kay <strong>BasCurtiz</strong> sa paggawa ng icon.",
    upToDate: {
    ...
    beforeReporting:
      "Bago ka magreport ng bug, siguraduhing pinakabagong version ang ginagamit mo at ang ire-report mo ay talagang bug at hindi dahil sa pagkakamali mo lang ng paggamit.",
    beSure:
      "Siguraduhing nangyayari rin ang bug sa iba't ibang plataporma at tsaka <strong>HUWAG</strong> mo nang i-report ang bug kung ito ay naipa-alam na ng iba.",
    duplicateReports:
      "Isasara namin ang mga magkaparehong report sa bug, kaya alamin mo muna.",
    dontOpenIssues:
      "<strong>HUWAG</strong> kayong magbubukas ng isyu kung magtatanong lang kayo, meron tayong subreddit para diyan.",
    newUI: {
    ...
    acceptFeatures:
      "Tumatangggap din ako ng mga feature, basta hindi komplikado, dahil diretso ko itong nilalagay sa app at hindi sa library.",
    otherLanguages:
      "Kung ikaw ay maraming alam sa ibang programming language, maaari mo ring subukan i-port ang deemix sa iba't ibang programming language!",
    understandingCode:
      "Kailangan mo ba ng tulong para maintindihan ang code? Bisitahin si waLplanet sa Telegram o sa Reddit.",
    contributeWebUI: {
      text: "Kung may alam ka sa Vue.js (JavaScript), HTML o kaya CSS, maaari kang sumali at tumulong dito sa {webui}.",
      webui: "WebUI",
    },
    itsFree:
      "Lagi mong tandaang <strong>ang proyektong ito ay libre</strong> at <strong>suportuhanmuna ang minamahal ninyong mga artist</strong> bago ang mga developer.",
    notObligated:
      "Huwag mong pilitin ang sarili para mag-donate, Naiintindihan ka namin!",
    lincensedUnder: {
  ...
  errors: {
    ...
    ids: {
      ...
      notYourPrivatePlaylist:
        "Hindi pwedeng i-download ang mga pribadong playlist ng iba.",
      ...
      notEncodedNoAlternative:
        "Hindi pa nae-encode ang track at walang mahanap na iba!",
      wrongBitrate: "Hindi mahanap ang track sa gusto mong bitrate.",
      wrongBitrateNoAlternative:
        "Hindi mahanap ang track sa gusto mong bitrate at walang mahanap na iba!",
      ...
      notAvailableNoAlternative:
        "Walang available na track sa server ng Deezer at walang mahanap na iba!",
  ...
  home: {
    needTologin:
      "Kailangan mong mag-log in sa iyong Deezer account bago ka makasimulang magdownload.",
  ...
  linkAnalyzer: {
    ...
    linkNotSupportedYet:
      "Mukhang hindi pa suportado itong link, iba na lang ang ilagay mo.",
    table: {
      id: "ID",
      isrc: "ISRC",
      upc: "UPC",
  ...
  toasts: {
    ...
    startConvertingSpotifyPlaylist:
      "Kino-convert ang mga track sa spotify papuntang Deezer",
    finishConvertingSpotifyPlaylist: "Naconvert na ang playlist sa Spotify",
    loginNeededToDownload:
      "Kailangan mong mag-login para madownload ang mga track!",
    deezerNotAvailable:
      "Hindi available ang Deezer sa iyong bansa. Kailangan mong gumamit ng VPN.",
  },
  settings: {
    title: "Mga Setting",
    language: "Wika",
    ...
    folders: {
      ...
      createStructurePlaylist:
        "Gumawa ng istraktura ng folder para sa mga playlist",
    ...
    covers: {
      ...
      embeddedPNGWarning:
        "Ang mga PNG ay hindi opisyal na suportado ng Deezer at maaaring magkaroon ng bug",
      imageSizeWarning:
        "Lahat ng mas mataas sa x1200 ay hindi opisyal na ginagamit sa Deezer, at posibleng magkaroon ng isyu",
      coverDescriptionUTF8:
        "I-save ang deskripsyon ng cover gamit ng UTF8 (iTunes Cover Fix)",
    },
    tags: {
