const pt_br = {
  ...
  about: {
    ...
    thanks:
      "Agradecimentos para <strong>rtonno</strong>, <strong>uhwot</strong> e <strong>lollilol</strong> por ajudar neste projeto, e para <strong>BasCurtiz</strong> por fazer o ícone",
    upToDate: {
    ...
    beforeReporting:
      "Antes de reportar um bug, tenha certeza que você está rodando a versão mais recente do app, e o que você quer reportar seja realmente um bug e não algo que esteja acontecendo especialmente com você.",
    beSure:
      "Certifique-se que o bug é reproduzivel em outras máquinas e também <strong>NÃO</strong> reporte um bug se ele já foi reportado.",
    duplicateReports:
      "Reportes de bugs duplicados serão fechados, então fique atento a isso.",
    dontOpenIssues:
      "<strong>NÃO</strong> abra tópicos para fazer perguntas, há o subreddit para isso.",
    newUI: {
    ...
    acceptFeatures:
      "Eu aceito funcionalidades extras também, mas nada de coisas complexas, desde que ela possa ser implementada no app, e não na biblioteca.",
    otherLanguages:
      "Se você for fluente em outra linguagem de programação, você pode tentar portar o deemix para outra linguagem!",
    understandingCode:
      "Você precisa de ajuda para entender o código? Mande mensagem no RemixDex pelo Telegram ou pelo Reddit.",
    contributeWebUI: {
      text: "Se você souber Vue.js (JavaScript), HTML ou CSS você pode contribuir para o {webui}.",
      webui: "WebUI",
    },
    itsFree:
      "Lembre-se que <strong>este projeto é livre</strong> e <strong>você deve dar suporte aos artistas que você ama</strong> antes de dar suporte aos desenvolvedores.",
    notObligated:
      "Não se sinta na obrigação de doar, eu agradeço de qualquer maneira!",
    lincensedUnder: {
