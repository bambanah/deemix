const fr = {
  globals: {
    welcome: "Bienvenue dans DeemixFix",
    back: "retour",
  ...
  about: {
    ...
    understandingCode:
      "Vous avez besoin d'aide pour comprendre le code ? Il suffit de contacter waLplanet sur Telegram ou Reddit.",
    contributeWebUI: {
  ...
  settings: {
    ...
    other: {
      ...
      albumVariousArtists:
        'Conserver "Various Artists" dans les Artistes de l\'Album',
