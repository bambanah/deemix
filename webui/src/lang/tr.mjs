const tr = {
	...
	about: {
		...
		subtitles: {
			...
			contributing:
				"Projeye katkı sağlamak mı istiyorsun? Farklı yollardan sağlayabilirsin!",
		...
		thanks:
			" <strong>rtonno</strong>, <strong>uhwot</strong> ve <strong>lollilol</strong>'a bu projeye yaptığı katkılardan ve <strong>BasCurtiz</strong>'e ikonlardan dolayı teşekkür ederim.",
		upToDate: {
		...
		beforeReporting:
			"Bir hatayı bildirmeden önce, uygulamanın son sürümünde olduğunuza veya sorunun sizden kaynaklı olmayıp bir hata olduğuna emin olduktan sonra emin olun.",
		beSure:
			"Hatanın başka cihazlarda da olduğunu doğrulayın ve <strong>Bildirilen</strong> bir hatayı tekrar bildirmeyin.",
		duplicateReports:
			"Birbirinin aynısı olan hata bildirileri kapatılacaktır, o yüzden dikkatli olun.",
		dontOpenIssues:
			"<strong>Soru sormak</strong> için hata bildirisi yollamayın, bunun için bir subreddit adresimiz var.",
		newUI: {
		...
		acceptFeatures:
			"Yeni özellikleri de kabul ediyorum, fakat karışık şeyleri kütüphaneye değil uygulamaya eklendiği için kabul edemiyorum.",
		otherLanguages:
			"Eğer diğer programlama dillerinde kendine güveniyorsan, deemix'i farklı dillere port etmeye çalışabilirsin!",
		understandingCode:
			"Kodu anlamak için yardım mı lazım? Reddit üzerinden veya Telegramdan waLplanet'e ulaş.",
		contributeWebUI: {
			text: "Eğer Vue.js (JavaScript), HTML veya CSS biliyorsan, {webui}.",
			webui: "Web Kullanıcı Arayüzüne katkıda bulanabilirsin",
		},
		itsFree:
			"Bunun <strong>ücretsiz bir proje olduğunu</strong> ve <strong>geliştiricilerden önce</strong> sevdiğiniz sanatçıları desteklemeniz gerektiğini unutmayın.",
		notObligated:
			"Kendinizi bağış yapmak zorunda hissetmeyin!, Sizi her halinizle seviyorum!",
		lincensedUnder: {
	...
	errors: {
		...
		ids: {
			...
			notYourPrivatePlaylist:
				"Başkalarının özel oynatma listelerini indiremezsin.",
			...
			notEncodedNoAlternative:
				"Parça henüz dönüştürülmedi ve alternatifi bulunamadı!",
			wrongBitrate: "Parça, istenen kalitede bulunamadı!",
			wrongBitrateNoAlternative:
				"Parça veya alternatifler istenen kalitede bulunamadı!",
			...
			notAvailableNoAlternative:
				"Parça veya Alternatifleri Deezer sunucularında bulunamadı.!",
		},
	},
	favorites: {
		title: "Favoriler",
	...
	linkAnalyzer: {
		...
		useful:
			"Mesela, ülkende dinlenebilir olmayan parçaların nerelerde var olduğunu bulmak için kullanabilirsin.",
		linkNotSupported: "Bu link şimdilik desteklenmemektedir.",
		linkNotSupportedYet:
			"Bu link şimdilik desteklenmiyor gibi duruyor, başkasını analiz etmeyi dene.",
		table: {
			id: "ID",
			isrc: "ISRC",
			upc: "UPC",
	...
	toasts: {
		...
		startConvertingSpotifyPlaylist:
			"Spotify parçaları deezer parçalarına dönüştürülüyor.",
