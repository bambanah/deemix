const pt = {
	...
	about: {
		...
		thanks:
			"Agradeço a <strong>rtonno</strong>, <strong>uhwot</strong> and <strong>lollilol</strong> por me ajudarem neste projeto e a <strong>BasCurtiz</strong> por elaborarem o ícone.",
		upToDate: {
		...
		beforeReporting:
			"Antes de reportares um bug certifica-te que estás a correr a versão mais recente e que se trata realmentede um bug e não apenas algo que não funciona do teu lado.",
		beSure:
			"Certifica-te que o erro é reprodutivel noutros dispositivos e <strong>NÃO</strong> reportes um bug que já tenha sido reportado.",
		duplicateReports:
			"Bug reports duplicados serão fechados, mantém-te atento a isso.",
		dontOpenIssues:
			"<strong>NÃO</strong> abras issues para colocar questões, existe um subreddit para isso.",
		newUI: {
		...
		acceptFeatures:
			"Também aceito funcionalidades não complexas caso possam ser implementadas directamente na app e não na biblioteca.",
		otherLanguages:
			"Caso sejas fluente noutra linguagem de programação podes tentar migrar o deemix para outra linguagem de programação!",
		understandingCode:
			"Precisas de ajuda a compreender o código? Acede a waLplanet no Telegram ou no Reddit.",
		contributeWebUI: {
			text: "Caso saibas Vue.js (JavaScript), HTML ou CSS podes contribuir para o {webui}.",
			webui: "WebUI",
		},
		itsFree:
			"Deves ter em conta que <strong>que este projeto é gratuito</strong> e <strong>deverás apoiar os artistas que aprecias</strong> antes de apoiares os programadores.",
