const ar = {
	...
	about: {
		...
		thanks:
			"شكرا لـ <strong>rtonno</strong>, و <strong>uhwot</strong> و <strong>lollilol</strong> لمساعدتي في هذا المشروع و لـ <strong>BasCurtiz</strong> لصنع الايقونة.",
		...
		beforeReporting:
			"قبل ان تبلغ عن خطأ، تأكد من أنك تشغل أحدث إصدار من التطبيق وأن ما تريد الإبلاغ عنه هو في الواقع خطأ وليس مشكلة من جهتك.",
		beSure:
			"تأكد من أن الخطأ يمكن إعادة إنتاجه على أجهزة أخرى و ايضاً <strong>لا</strong> تبلغ علة خطأ تم التبليغ عنه سابقاً.",
		...
		acceptFeatures:
			"أقبل اقتراحات الميزات أيضًا ، ولكن لا أشياء معقدة ، فقط اشياء يمكنني تنفيذها مباشرة في التطبيق وليس في المكتبة.",
		otherLanguages:
			"إذا كنت تجيد لغة برمجة أخرى ، يمكنك محاولة تحويل ديمكس إلى لغات برمجة أخرى!",
		understandingCode:
			"أنت بحاجة إلى مساعدة في فهم الكود؟ فقط اتصل بـ waLplanet على تيليكرام او ريديت.",
		itsFree:
			"يجب ان تتذكر ان <strong>هذا هو مشروع مجاني</strong> <strong>و عليك دعم الفنانين المفضلين لك قبل ان تدعم مطورين البرنامج</strong>.",
	...
	linkAnalyzer: {
		...
		linkNotSupportedYet:
			"يبدو أن هذا الرابط غير معتمد حتى الآن ، حاول تحليل رابط آخر.",
		table: {
			id: "ID",
			isrc: "ISRC",
			upc: "UPC",
