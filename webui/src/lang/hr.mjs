const hr = {
	...
	about: {
		...
		subtitles: {
			...
			contributing:
				"Želiš doprinijeti ovom projektu? Možeš i to čak u više načina!",
		...
		thanks:
			"Hvala <strong>rtonno</strong>, <strong>uhwot</strong> i <strong>lollilol</strong> što su mi pomogli s ovim projektom te <strong>BasCurtiz</strong> što su napravili ikonu.",
		upToDate: {
		...
		beforeReporting:
			"Prije prijavljivanja greške provjerite imate li instaliranu zadnju verziju aplikacije i da to što želite prijaviti je ustvari pogreška, a ne nešto što samo vama ne radi.",
		beSure:
			"Provjerite može li se pogreška reproducirati i na drugim uređajima i također <strong>NEMOJTE</strong> prijavljivati grešku ako je već prijavljena.",
		duplicateReports:
			"Duplicirane prijave o greški bit će zatvorene, tako da pripazite na to.",
		dontOpenIssues:
			"<strong>NEMOJTE</strong> otvarati issue za postavljanje pitanja, za to postoji subreddit.",
		newUI: {
		...
		acceptFeatures:
			"Prihavaćam i značajke, ali bez kompleksnih stvari, jer one mogu biti implementirane direktno u aplikaciji, a ne u biblioteci.",
		otherLanguages:
			"Ako ste vješti u drugom programskom jezikumožete probati portati deemix u drugi programski jezik!",
		understandingCode:
			"Trebate pomoć s razumijevanjem koda? Samo potraži waLplanet na Telegramu ili Redditu.",
		contributeWebUI: {
			text: "Ako znaš Vue.js (JavaScript), HTML ili CSS možete doprinijeti za {webui}.",
			webui: "WebUI",
		},
		itsFree:
			"Trebate zapamtiti da je ovo <strong>besplatni projekt</strong> i <strong>trebali biste podržati autore koje volite</strong> prije podržavanja developera.",
		notObligated:
			"Nemojte se osjećati obveznim darivati, svejedno vas cijenim!",
		lincensedUnder: {
	...
	errors: {
		...
		ids: {
			...
			notEncodedNoAlternative:
				"Pjesma još nije enkodirana i nije pronađena alternativa!",
			wrongBitrate: "Pjesma nije pronađena u željenom bitrateu.",
			wrongBitrateNoAlternative:
				"Pjesma nije pronađena u željenom bitrateu i nije pronađena alternativa!",
			...
			notAvailableNoAlternative:
				"Pjesma nije dostupna na Deezerovim serverima i alternativa nije pronađena!",
		},
	},
	favorites: {
		title: "Favoriti",
	...
	home: {
		needTologin:
			"Trebate se prijaviti sa svojim Deezer računom kako biste mogli početi preuzimati pjesme.",
	...
	linkAnalyzer: {
		...
		linkNotSupportedYet:
			"Čini se da ovaj link još nije podržan, pokušaj analizirati neki drugi.",
		table: {
			id: "ID",
			isrc: "ISRC",
			upc: "UPC",
	...
	settings: {
		...
		downloads: {
			...
			saveDownloadQueue:
				"Spremi red za preuzimanje prilikom zatvaranja aplikacije",
		},
		covers: {
			title: "Omoti albuma",
