const es = {
  ...
  about: {
   ...
   '¡Si dominas otro lenguaje de programación podrías intentar portar Deemix a otros lenguajes de programación!',
    understandingCode: '¿Necesitas ayuda para entender el código? Sólo tienes que poner waLplanet en Telegram o Reddit.',
    contributeWebUI: {
      ...
      arl: {
        ...
        howTo: {
          prologue: {
            ...
            warning: 'Utiliza este método sólo si el correo electrónico y la contraseña no funcionan.'
          },
          chromeSteps: {
            title: 'Chrome',
            step1: 'Abrir Chrome',
            easyWay: {
              ...
              step3: 'Hacer clic en el pequeño icono de "candado" que aparece junto a la URL',
