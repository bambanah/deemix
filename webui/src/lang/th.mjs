const th = {
  ...
  about: {
    ...
    thanks:
      "ขอขอบคุณ <strong>rtonno</strong>, <strong>uhwot</strong> และ <strong>lolililol</strong> ที่ช่วยเหลือผมในโครงการนี้และ <strong>BasCurtiz</strong> ที่ช่วยทำไอคอนแอป",
    upToDate: {
    ...
    beforeReporting:
      "ก่อนที่จะรายงานจุดบกพร่อง ตรวจสอบให้แน่ใจว่าคุณกำลังใช้งานแอปเวอร์ชันล่าสุดและสิ่งที่คุณต้องการรายงานนั้นเป็นข้อบกพร่องจริง ๆ และไม่ใช่สิ่งผิดปกติที่เกิดขึ้นในเครื่องของคุณเท่านั้น",
    beSure:
      "ตรวจสอบให้แน่ใจว่าสามารถทำบักซ้ำได้บนเครื่องอื่น และ <strong>อย่า</strong> รายงานจุดบกพร่องหากมีการรายงานเข้ามาแล้ว",
    duplicateReports: "การรายงานข้อผิดพลาดที่ซ้ำกันจะถูกปิด ดังนั้นโปรดดูให้ดี",
    dontOpenIssues:
      "<strong>ห้าม</strong>Open Issue เพื่อถามคำถาม เรามีซับเรดดิตไว้สำหรับการตอบคำถามแล้ว",
    newUI: {
    ...
    acceptFeatures:
      "เราเปิดรับคุณสมบัติใหม่ด้วย แต่ต้องไม่ใช่สิ่งที่ซับซ้อน เพราะสามารถปรับใช้งานได้โดยตรงในแอป ไม่ใช่ในไลบรารี",
    otherLanguages:
      "หากคุณถนัดการเขียนโปรแกรมด้วยภาษาอื่น คุณสามารถลองพอร์ต deemix เป็นภาษาโปรแกรมอื่น ๆ ได้!",
    understandingCode:
      "หากคุณต้องการความช่วยเหลือในการทำความเข้าใจโค้ด สามารถติดต่อ waLplanet ได้ทาง Telegram หรือ Reddit",
    contributeWebUI: {
      text: "หากคุณถนัดภาษา Vue.js (JavaScript), HTML หรือ CSS คุณสามารถมีส่วนร่วมในการพัฒนา {webui} ได้",
      webui: "WebUI",
    },
    itsFree:
      "พึงระลึกเสมอว่า <strong>นี่เป็นโปรเจ็กต์ฟรี</strong>และ<strong>คุณควรสนับสนุนศิลปินที่คุณรัก</strong> ก่อนที่จะสนับสนุนนักพัฒนาโปรแกรมนี้",
