const id = {
	...
	about: {
		...
		subtitles: {
			bugReports:
				"Ada yang tidak bekerja dengan baik di deemix? Beri tahu kami!",
			contributing:
				"Mau kontribusi dalam proyek ini? Kamu bisa lakukan dengan banyak hal!",
		...
		thanks:
			"Terima kasih kepada <strong>rtonno</strong>, <strong>uhwot</strong> dan <strong>lollilol</strong> yang telah membantuku dalam proyek ini, serta kepada <strong>BasCurtiz</strong> yang telah membuat ikon.",
		upToDate: {
		...
		beforeReporting:
			"Sebelum melaporkan masalah, pastikan kamu sudah memakai versi aplikasi terbaru dan hal yang akan kamu laporkan memang bukan kesalahan dari pihak kamu sendiri.",
		beSure:
			"Pastikan masalah tersebut bisa diemulasikan di mesin lain, dan juga <strong>JANGAN</strong> laporkan masalah yang sudah dilaporkan sebelumnya.",
		duplicateReports:
			"Laporan duplikat akan kami tutup, jadi perhatikan baik-baik.",
		dontOpenIssues:
			"<strong>JANGAN</strong> buka issue baru untuk mengirimkan pertanyaan, silakan lakukan di subreddit.",
		newUI: {
		...
		acceptFeatures:
			"Kami juga menerima fitur baru, tapi jangan yang terlalu kompleks, karena hal itu lebih baik diimplementasikan langsung di aplikasi daripada di pustaka.",
		otherLanguages:
			"Kalau kamu mahir dengan bahasa pemrograman lain, kamu bisa coba mentransfer deemix ke bahasa tersebut!",
		understandingCode:
			"Butuh bantuan untuk memahami kode deemix? Kontak waLplanet di Telegram atau Reddit.",
		contributeWebUI: {
			text: "Kalau kamu paham Vue.js (JavaScript), HTML, atau CSS, kamu bisa berkontribusi pada {webui}.",
			webui: "WebUI",
		},
		itsFree:
			"Perlu diingat bahwa <strong>ini adalah proyek gratis</strong> dan <strong>dukung artis idolamu terlebih dahulu</strong> sebelum mendukung kami sebagai pengembang aplikasi.",
		notObligated:
			"Jangan merasa terpaksa untuk menyumbang, kami tetap menghargai kamu!",
		lincensedUnder: {
	...
	errors: {
		...
		ids: {
			...
			notYourPrivatePlaylist:
				"Kamu tidak bisa mengunduh daftar putar privat orang lain.",
			...
			notEncodedNoAlternative:
				"Lagu belum di-encode dan tidak ada alternatif lain!",
			wrongBitrate: "Lagu tidak tersedia pada bitrate yang diinginkan.",
			wrongBitrateNoAlternative:
				"Lagu tidak tersedia pada bitrate yang diinginkan dan tidak ada alternatif lain!",
			...
			notAvailableNoAlternative:
				"Lagu tidak tersedia pada server deezer dan tidak ada alternatif lain!",
		},
	},
	favorites: {
		title: "Favorit",
	...
	home: {
		needTologin:
			"Kamu harus masuk ke akun Deezer kamu sebelum bisa memulai pengunduhan.",
	...
	linkAnalyzer: {
		...
		linkNotSupportedYet:
			"Sepertinya tautan ini belum didukung, silakan coba analisa tautan lain.",
		table: {
			id: "ID",
			isrc: "ISRC",
			upc: "UPC",
