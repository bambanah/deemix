const en = {
	...
	about: {
		...
		updates: {
			...
			updateAvailable:
				"You're not running the latest version available: {version}",
		...
		thanks:
			"Thanks to <strong>rtonno</strong>, <strong>uhwot</strong> and <strong>lollilol</strong> for helping me with this project and to <strong>BasCurtiz</strong> for making the icon.",
		upToDate: {
		...
		beforeReporting:
			"Before reporting a bug make sure you're running the latest version of the app and that what you want to report is actually a bug and not something that's wrong only on your end.",
		beSure:
			"Make sure the bug is reproducible on other machines and also <strong>DO NOT</strong> report a bug if it's already been reported.",
		duplicateReports:
			"Duplicate bug reports will be closed, so keep an eye out on that.",
		dontOpenIssues:
			"<strong>DO NOT</strong> open issues for asking questions, there is a subreddit for that.",
		newUI: {
		...
		understandingCode:
			"You need help understanding the code? Just hit waLplanet up on Telegram or Reddit.",
		contributeWebUI: {
			text: "If you know Vue.js (JavaScript), HTML or CSS you could contribute to the {webui}.",
			webui: "WebUI",
		},
		itsFree:
			"You should remember that <strong>this is a free project</strong> and <strong>you should support the artists you love</strong> before supporting the developers.",
