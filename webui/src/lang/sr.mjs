const sr = {
  ...
  about: {
    ...
    thanks:
      "Хвала корисницима <strong>rtonno</strong>, <strong>uhwot</strong> и <strong>lollilol</strong> што су ми помогли на овом пројекту и хвала кориснику <strong>BasCurtiz</strong> што је направио иконицу.",
    upToDate: {
    ...
    beforeReporting:
      "Пре него што пријавите грешку, проверите да ли имате најновију верзију апликације. Такође, постарајте се да то што желите да пријавите не представља неку грешку која се јавља само код вас.",
    beSure:
      "Проверите да ли се грешка може репродуковати на другим уређајима. <strong>НЕМОЈТЕ</strong> да пријављујете грешку уколико је већ пријављена.",
    duplicateReports:
      "Дупликати пријављених грешака биће затворени, обратите пажњу на то.",
    dontOpenIssues:
      "<strong>НЕМОЈТЕ</strong> да отварате issue да бисте поставили питање, постоји подредит за ту намену.",
    newUI: {
    ...
    acceptFeatures:
      "Прихватам и нове опције, уколико нису превише сложене, које се могу имплементирати у апликацији а не библиотеци.",
    otherLanguages:
      "Уколико знате неки други програмски језик, можете да пробате да портујете deemix на други програмски језик!",
    understandingCode:
      "Треба вам помоћ да разумете код? Потражите waLplanet на Телеграму или Редиту.",
    contributeWebUI: {
      text: "Ако знате Vue.js (JavaScript), HTML или CSS, можете да допринесете {webui}-у.",
      webui: "WebUI",
    },
    itsFree:
      "Имајте на уму да је ово <strong>бесплатни пројекат</strong> и да би требало да <strong>подржите извођаче које волите</strong> пре него да подржите програмере.",
