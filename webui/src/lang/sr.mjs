const sr = {
  globals: {
    welcome: 'Добродошли у DeemixFix',
    back: 'назад',
    loading: 'Учитавам',
  ...
  about: {
   ...
   'Ова апликација користи <strong>deemix</strong> библиотеку, коју можете да користите да направите свој кориснички интерфејс за deemix.',
    ...
    questions: {
      text: 'Уколико имате питања или проблеме са апликацијом, потражите прво решење на {telegram}. Након тога, уколико нисте нашли одговор, можете да направите нови пост са описом проблема на {telegram}.',
      telegram: 'Telegram'
    },
    ...
    understandingCode: 'Треба вам помоћ да разумете код? Потражите waLplanet на Телеграму или Редиту.',
    contributeWebUI: {
