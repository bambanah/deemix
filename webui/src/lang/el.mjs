const gr = {
	globals: {
		welcome: "Καλωσόρισες στο DeemixFix",
		back: "Πίσω",
		loading: "φόρτωση",
		download: "Λήψη {thing}",
		by: "από {artist}",
	...
	about: {
		...
		updates: {
			...
			updateAvailable:
				"Δεν εκτελείτε την πιο πρόσφατη διαθέσιμη έκδοση: {version}",
		...
		thanks:
			"Ευχαριστώ τους <strong>rtonno</strong>, <strong>uhwot</strong> και <strong>lollilol</strong> που με βοήθησαν σε αυτό το έργο και τον <strong>BasCurtiz</strong> για τη δημιουργία του εικονιδίου του deemix.",
		upToDate: {
		...
		questions: {
			text: "Εάν έχετε ερωτήσεις ή προβλήματα με την εφαρμογή, αναζητήστε αρχικά μια λύση στο {telegram}. Εάν δεν βρείτε τη λύση εκεί, μπορείτε να κάνετε μια ανάρτηση με το πρόβλημά σας στο {telegram}.",
			telegram: "Telegram",
		},
		beforeReporting:
			"Πριν αναφέρετε κάποιο σφάλμα, βεβαιωθείτε αρχικά ότι εκτελείτε την τελευταία έκδοση της εφαρμογής και ότι το συγκεκριμένο σφάλμα δεν είναι κάποιο πρόβλημα από πλευράς σας.",
		beSure:
			"Βεβαιωθείτε ότι το σφάλμα συμβαίνει και σε άλλα μηχανήματα, πχ δοκιμάζοντας σε κάποιον άλλον υπολογιστή και <strong>ΜΗΝ</strong> αναφέρετε σφάλματα που έχουν ήδη αναφερθεί.",
		duplicateReports:
			"Οι διπλές αναφορές σφαλμάτων θα κλείνουν, οπότε έχετε το νου σας σε αυτό.",
		dontOpenIssues:
			"<strong>ΜΗΝ</strong> ανοίγετε ζητήματα για υποβολή απλών ερωτήσεων, υπάρχει subreddit για αυτό.",
		newUI: {
		...
		acceptFeatures:
			"Δέχομαι και επιπλέον λειτουργίες, αλλά όχι περίπλοκα πράγματα, έτσι ώστε να μπορούν να υλοποιηθούν απευθείας στην εφαρμογή και όχι στη βιβλιοθήκη.",
		otherLanguages:
			"Εάν χειρίζεστε άριστα οποιαδήποτε άλλη γλώσσα προγραμματισμού, μπορείτε να προσπαθήσετε να μεταφέρετε το deemix σε αυτή τη γλώσσα!",
		understandingCode:
			"Χρειάζεστε βοήθεια για την κατανόηση του κώδικα; Απλώς πατήστε το waLplanet στο Telegram ή το Reddit.",
		contributeWebUI: {
			text: "Εάν γνωρίζετε Vue.js (JavaScript), HTML ή CSS, μπορείτε να συνεισφέρετε στο {webui}.",
			webui: "WebUI",
		},
		itsFree:
			"Πρέπει να έχετε υπόψιν ότι <strong>αυτό πρότζεκτ είναι δωρεάν</strong> και <strong>ότι θα πρέπει αρχικά να υποστηρίξετε τους καλλιτέχνες που αγαπάτε</strong> και μετά τους προγραμματιστές.",
		notObligated:
			"Μην αισθάνεστε υποχρεωμένοι να κάνετε κάποια δωρεά, σας εκτιμώ ούτως ή άλλως!",
		lincensedUnder: {
