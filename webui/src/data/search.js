...
export function formatSingleTrack (track) {
  ...
  return {
    ...
    albumPicture: getPropertyWithFallback(track, 'album.cover_small') || `https://e-cdns-images.dzcdn.net/images/cover/${track.ALB_PICTURE}/56x56-000000-80-0-0.jpg`
  }
}
...
export function formatAlbums (album) {
  ...
  return {
    ...
    albumCoverMedium: getPropertyWithFallback(album, 'cover_medium') || `https://e-cdns-images.dzcdn.net/images/cover/${album.ALB_PICTURE}/156x156-000000-80-0-0.jpg`,
...
export function formatArtist (artist) {
  return {
    ...
    artistPictureMedium: getPropertyWithFallback(artist, 'picture_medium') || `https://e-cdns-images.dzcdn.net/images/artist/${artist.ART_PICTURE}/156x156-000000-80-0-0.jpg`,
...
export function formatPlaylist (playlist) {
  return {
    ...
    playlistPictureMedium: getPropertyWithFallback(playlist, 'picture_medium') || `https://e-cdns-images.dzcdn.net/images/${playlist.PICTURE_TYPE}/${playlist.PLAYLIST_PICTURE}/156x156-000000-80-0-0.jpg`,
